...
"")
        ...
        self.videoLabel.setGeometry(QRect(1750, 70, 151, 151))
        self.toggleInputButton = QPushButton(self.Main_pg)
        self.toggleInputButton.setObjectName(u"toggleInputButton")
        self.toggleInputButton.setGeometry(QRect(1270, 850, 191, 21))
...
"background-color: rgb(245, 194, 17);")
        ...
        self.powerSlider.setGeometry(QRect(1270, 870, 191, 16))
        ...
        self.mapToggler.setGeometry(QRect(1230, 400, 91, 21))
        ...
        self.maincameraToggler.setGeometry(QRect(1720, 30, 201, 26))
        ...
        self.mapImageView.setGeometry(QRect(1230, 440, 331, 331))
        ...
        self.verticalLayoutWidget_3.setGeometry(QRect(1240, 50, 411, 301))
